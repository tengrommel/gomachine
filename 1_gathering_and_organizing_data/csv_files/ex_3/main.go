...
func main() {
	...
	f, err := os.Open("1_gathering_and_organizing_data/csv_files/data/iris_mixed_types.csv")
	if err != nil {
		log.Fatal(err)
	}
	defer f.Close()
	...
	// Create a slice value that will hold all of the successfully parsed records from the CSV
